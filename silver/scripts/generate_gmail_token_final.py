#!/usr/bin/env python3
"""
Generate Gmail OAuth Token - FINAL WORKING VERSION

This uses a custom approach to capture the URL and handle the flow properly.

Usage:
    python scripts/generate_gmail_token_final.py
"""
...
def generate_token():
    ...
    print("\n" + "="*70)
    print("🔐 Gmail OAuth Token Generator - FINAL VERSION")
    print("="*70)
...
if __name__ == "__main__":
    try:
        ...
        if success:
            print("\n✅ Next: python src/watchers/gmail_watcher.py\n")

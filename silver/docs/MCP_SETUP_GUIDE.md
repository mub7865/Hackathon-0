# MCP Servers Setup Guide - Silver Tier
...
2. Create a new project (e.g., "Silver-AI-Employee")
3. Enable Gmail API:
...
Once Gmail MCP is set up, the Silver Tier AI Employee will be fully functional for email and LinkedIn tasks!
